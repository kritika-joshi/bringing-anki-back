...
class QLearn:
    ...
    def loadQ(self, filename):
        ...
        with open('/home/fizzer/enph353_ws/src/BRINGING-ANKI-BACK/competition_2019t2/nodes/'+filename+".pickle", "wb") as f:
            pickle.load(f)
    ...
    def saveQ(self, filename):
        ...
        print("Wrote to file: {}".format('/home/fizzer/enph353_ws/src/BRINGING-ANKI-BACK/competition_2019t2/nodes/'+filename+".pickle"))
