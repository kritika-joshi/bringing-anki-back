...
class Gazebo_Lab06_Env(gazebo_env.GazeboEnv):
    ...
    def __init__(self):
        ...
        LAUNCH_FILE = '/home/fizzer/enph353_ws/src/bringing-anki-back/competition_2019t2/launch/nav_qlearn.launch'
    ...
    def process_image(self, data):
        '''
            @brief Converts data into a opencv image and displays it
        ...
        cropped_thresh = thresh2[200:240, 0:320]
        ...
        while(flag):
            if(current_location > cY):
                ...
                state[state_arr_index] = 1
                print(state)
                print("index:")
                print(state_arr_index)
                flag = False
            else:
                print("in the else loop")
                state_arr_index+=1
                current_location+= q_width
                print("Here is the current location:")
        ...
        #need to add something to increment self.timeout
    ...
    def reset(self):
        ...
        while data is None:
            try:
                data = rospy.wait_for_message('/rrbot/camera1/image_raw',
                                              Image, timeout=5)
            except:
                pass
